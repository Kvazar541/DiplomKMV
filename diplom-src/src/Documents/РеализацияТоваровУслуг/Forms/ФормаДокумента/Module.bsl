...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//ВКМ_добавляем команду "Заполнить" на форму
	НоваяКоманда = ЭтаФорма.Команды.Добавить("Заполнить");
	НоваяКоманда.Действие = "Заполнить";  
	НовыйЭлемент = Элементы.Добавить("КомандаПредупредить", Тип("КнопкаФормы"), КоманднаяПанель);
...
//ВКМ_Обработчик кнопки Заполнить 
&НаКлиенте
...
Процедура ВКМ_ЗаполнитьНаСервере()
	...
	Иначе ОбщегоНазначения.СообщитьПользователю("Для данного договора автоматическое заполнение недоступно.");
