...
2) Файт автотеста - ОбщийСценарий.feature использует экспортные сценарии, поэтому необходимо создать библиотеку для экспортных сценариев и сохранить туда следующие файлы:
...
3) Необходимо выполнить все действия из инструкции по начальной настройке программы.
4) Необходимо создать следующие объекты:

- Контрагент с Наименованием "Контрагент1" и абонентским договором "ОсновнойДоговор1-2023". Для договора указать период действия - весь 2023 год, Абонентская плата - "15000" и стоимость часа работы "400"
